...
通过 Google 搜索 + Kimi WebBridge 查找阿里巴巴中国（1688.com）批发供应商并提取完整的联系信息。

**核心思路：** 在 Google 搜索 1688 工厂页面 → 提取店铺子域名 → 访问联系信息页面 → 获取电话、手机、地址和联系人。
...
1. **Google 搜索** — `site:1688.com/factory <产品>` 查找工厂页面，不会触发 reCAPTCHA
...
7. **补充信息（可选）** — 如果缺少联系人，可在 Google 搜索工商注册信息
...
| 公司 | 电话 | 手机 | 地址 | 联系人 | 店铺 |
|------|------|------|------|--------|------|
| 示例轴承有限公司 | 86 010 12345678 | 13800138000 | 北京市... | 张先生 | example.1688.com |

## 参考资料

- `references/google-search.md` — Google 搜索结果提取脚本
