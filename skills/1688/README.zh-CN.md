...
通过 Bing/Google 搜索 + Kimi WebBridge 查找阿里巴巴中国（1688.com）批发供应商并提取完整的联系信息。

**核心思路：** 在 Bing/Google 搜索 1688 工厂页面 → 提取店铺子域名 → 访问联系信息页面 → 获取电话、手机、地址和联系人；联系人缺失时 Kimi 优先调用天眼查补充。
